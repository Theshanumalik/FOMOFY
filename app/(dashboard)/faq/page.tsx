        ...
        <div className="join join-vertical w-full max-w-xl mx-auto">
          <div className="collapse collapse-arrow join-item border">
            ...
            <div className="collapse-content">
              <p>
                To get started, you need to create a project. After creating a
                project, you can copy the embed code and paste it into your
                website.
              </p>
            </div>
          </div>
          ...
          <div className="collapse collapse-arrow join-item border">
            ...
            <div className="collapse-content">
              <p>
                FOMOFY uses jquery and css to create beautiful and engaging
                FOMO. You can customize the FOMO notification as per your needs.
              </p>
            </div>
          </div>
          <div className="collapse collapse-arrow join-item border">
